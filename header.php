			...
			<section class="signin">
				...
				<form action="#">
					<div class="input fields">
						...
						<input type="" name="email" id="" placeholder="Email">
					</div>
					<div class="input fields">
						<label for="">Password</label>
						<input type="password" name="pass" id="checkpass" placeholder="Password">
					</div>
				...
				<div class="advice">
					Chưa có tài khoản?
					<a href="#" class="a_dang_ky">Đăng ký ngay.</a>
				</div>
			</section>
	...
	<div class="dangky">
		...
		<div class="wrapper">
			<section class="signup">
				...
				<div class="advice">
					Đã có tài khoản?
					<a href="#" class="a_dang_ky">Đăng nhập ngay.</a>
				</div>
			</section>
		</div>
	</div>
    <div class="sum">
		<div class="top">
			...
			<?php 
				...
				if(isset($_SESSION['adphim']) and isset($_COOKIE['adphim'])){?>
						<a class="btn-themphim" href="dangxuat.php">Đăng xuất</a>
						<a class="btn-themphim" href="admin">Quản lý phim</a>
				...
				<?php }
				else if(isset($_SESSION['user']) and isset($_COOKIE['user'])){?>
					<a class="btn-themphim" href="dangxuat.php">Đăng xuất</a>
					<a class="btn-themphim" href="phimyeuthich.php">DS phim yêu thích</a>
				<?php }
			...
			<label class="switch">
				<input type="checkbox" onclick="nentoi()">
		...
		<div class="danhmuc">
			...
			<div class="bdm"><a href="phimbo.php">Phim Bộ</a></div>
			<div class="bdm"><a href="phimle.php">Chiếu rạp</a></div>
		...
		<script src="js/nentoi.js"></script>
        <script>
